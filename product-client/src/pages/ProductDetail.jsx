      ...
      <main className="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mt-4">
          <button
            type="button"
            onClick={() => navigate('/')}
            className="inline-flex items-center justify-center rounded-lg bg-slate-700 px-4 py-2 text-sm font-medium text-white transition
            hover:bg-slate-600">
            목록으로
          </button>
        </div>
    ...
    <main className="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
      <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-6 space-y-3 text-sm text-slate-700">
          ...
          <div className="flex items-center justify-between border-b border-slate-100 pb-2">
            <span className="font-medium text-slate-500">가격</span>
            <span className="font-semibold text-slate-900">{Number(product.price).toLocaleString()}원</span>
          </div>
          <div className="flex items-center justify-between border-b border-slate-100 pb-2">
            <span className="font-medium text-slate-500">재고</span>
            <span className="font-semibold text-slate-900">{product.stock}개</span>
          </div>
        </div>
